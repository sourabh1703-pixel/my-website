# Let me recreate the pages directory and update all the files with improved text visibility
import os

# Create pages directory
os.makedirs('pages', exist_ok=True)

# Update Portfolio.py with improved text visibility
