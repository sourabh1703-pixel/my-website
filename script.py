# Let's update the CSS to fix text visibility in white boxes
# I'll create an updated version of the main app.py with better contrast
...
# Page configuration
st.set_page_config(
    page_title="SAPMaster Solutions - SAP Consulting & GenAI Automation",
    page_icon="⚡",
    layout="wide",
...
def render_hero_section():
    ...
    <div class="hero-section">
        <h1 class="hero-title">SAPMaster Solutions</h1>
...
def render_stats_section():
    ...
    <div class="stats-container">
        <div style="text-align: center; margin-bottom: 2rem;">
            <h2 style="margin-bottom: 1rem; color: white;">Why Choose SAPMaster Solutions?</h2>
...
def render_about_section():
    ...
    st.markdown("## 🏢 About SAPMaster Solutions")
    ...
    with col1:
        ...
        <div class="service-card white-container">
            <p style="font-size: 1.1rem; line-height: 1.8; color: #555 !important;">
                At <strong style="color: #333 !important;">SAPMaster Solutions</strong>, we are passionate about transforming businesses through 
    ...
    with col2:
        ...
        <div class="service-card white-container">
            ...
            <ul class="service-features">
                ...
                <li style="color: #555 !important;">Financial Services</li>
...
# Save the updated main application file
with open('app.py', 'w', encoding='utf-8') as f:
    f.write(updated_app_code)

print("✅ Updated app.py with improved text visibility")
print("🔧 Fixed issues:")
print("   - Added explicit color declarations for all text elements")
print("   - Improved contrast for white background containers") 
print("   - Fixed navigation text visibility")
print("   - Enhanced service card text readability")
print("   - Added !important declarations to override default styles")